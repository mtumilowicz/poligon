...
public class FindMissingIntInAnArithmeticSequenceTests {
    ...
    public void base1diff1miss2() {
        assertEquals(2, 
                FindMissingIntInAnArithmeticSequence.find(new int[]{1, 3}, 1, 1));
    }

    @Test
    public void base1diff1miss3() {
        assertEquals(3, 
                FindMissingIntInAnArithmeticSequence.find(new int[]{1, 2, 4}, 1, 1));
    }

    @Test
    public void base1diff1miss5() {
        assertEquals(5, 
                FindMissingIntInAnArithmeticSequence.find(new int[]{1, 2, 3, 4, 6}, 1, 1));
    }

    @Test
    public void base1diff1missFirst() {
        assertEquals(1, 
                FindMissingIntInAnArithmeticSequence.find(new int[]{2, 3, 4, 5, 6, 7}, 1, 1));
    }

    @Test
    public void base1diff1missLast() {
        assertEquals(8, 
                FindMissingIntInAnArithmeticSequence.find(new int[]{1, 2, 3, 4, 5, 6, 7}, 1, 1));
    }
