...
public class IteratorsComparatorTests {
    ...
    public void fEmptySNotEmpty() {
        Assert.assertFalse(IteratorsComparator.equals(new LinkedList<>(), new LinkedList<>(Collections.singletonList(1))));
    }

    @Test
    public void fNotEmptySEmpty() {
        Assert.assertFalse(IteratorsComparator.equals(new LinkedList<>(Collections.singletonList(1)), new LinkedList<>()));
    }
    ...
    public void notEmptyDifferentTypes() {
        Assert.assertFalse(IteratorsComparator.equals(new LinkedList<>(Collections.singletonList("a")), 
                new LinkedList<>(Collections.singletonList(1))));
    }

    @Test
    public void sameElementLength1() {
        Assert.assertTrue(IteratorsComparator.equals(new LinkedList<>(Collections.singletonList("a")),
                new LinkedList<>(Collections.singletonList("a"))));
    }
