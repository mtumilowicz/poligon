...
public class IntervalsMergerTests {
    ...
    public void merge_interval_1_2() {
        assertThat(new LinkedList<>(Collections.singletonList(interval_1_2)),
                is(IntervalsMerger.merge(new ArrayList<>(Collections.singletonList(interval_1_2)))));
    }

    @Test
    public void merge_interval_1_2_interval_1_3() {
        assertThat(new LinkedList<>(Collections.singletonList(interval_1_3)),
    ...
    public void merge_interval_1_2_interval_1_3_interval_1_4() {
        assertThat(new LinkedList<>(Collections.singletonList(interval_1_4)),
