...
public class DatePeriodsMergerTests {
    ...
    public void merge_period_1_2() {
        assertThat(new LinkedList<>(Arrays.asList(period_1_2)), 
                is(DatePeriodsMerger.merge(new ArrayList<>(Arrays.asList(period_1_2)))));
    }
    
    @Test
    public void merge_period_1_2_period_1_3() {
        assertThat(new LinkedList<>(Arrays.asList(period_1_3)),
    ...
    public void merge_period_1_2_period_1_3_period_1_4() {
        assertThat(new LinkedList<>(Arrays.asList(period_1_4)),
